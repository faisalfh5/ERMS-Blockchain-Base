                ...
                <div className="row">
                  <div className="col-md-6 ">
                    <div className="detail-box">
                      ...
                      <p>
                        Dapps are a growing movement of applications that use
                        Ethereum to disrupt business models or invent new ones.
                      </p>
        ...
        <div className="service_container">
          <div className="container ">
            <div className="heading_container heading_center">
              ...
              <p>
                We offer a blockchain-based supply chain solution, ensuring
                transparency, traceability, and secure verification of goods.
              </p> */}
            </div>
            <div className="row">
            ...
            <div className="box">
              ...
              <div className="detail-box">
                ...
                <p>
                  ...
                  achieve optimal outcomes. It includes tasks such as
                  identifying experts, assigning roles, facilitating
                  collaboration, and ensuring their knowledge is effectively
                  applied to achieve project goals.
                </p>
              </div>
            </div>
            <div className="box">
              ...
              <div className="detail-box">
                ...
                <p>
                  ...
                  manually manage and update records, saving HR departments
            ...
            <div className="box">
              ...
              <div className="detail-box">
                ...
                <p>
                  ...
                  it's been recorded to the shared ledger. If a transaction
                  record includes an error, a new transaction must be added to
